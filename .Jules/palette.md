...
## 2024-05-26 - Mandatory Site Battery
**Learning:** Constantly threatening the user with a site-wide failure based on a meaningless and rapidly draining arbitrary resource forces them to perform repetitive, unhelpful physical actions just to maintain access, making the entire browsing experience extremely taxing.
**Action:** Added a "Site Battery" that constantly drains. If it hits 0%, a full-screen overlay blocks all interaction. The only way to recharge it is to vigorously and continuously shake the mouse to generate "kinetic energy".
