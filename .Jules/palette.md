...
## 2024-05-27 - Slow Modal Closing
**Learning:** By making the close button of a modal take 5 seconds to process, and removing the ability to click outside to close, we force the user to sit and watch a progress bar every time they want to dismiss a dialog.
**Action:** Implemented a slow closing mechanism for modals and removed the click-outside-to-close feature.
