...
## 2024-05-26 - Eco-Friendly Mode (Kinetic Energy)
**Learning:** Users will perform meaningless manual labor (like constantly wiggling their mouse) if it is framed as a mandatory requirement to keep the system running under the guise of "saving the environment".
**Action:** Implemented an "Eco-Friendly Mode" that forces the screen to go black unless the user constantly moves their mouse to generate "kinetic energy", pairing diabolically with the existing hover-to-unblur mechanic.
