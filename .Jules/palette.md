...
## 2024-05-26 - Active Reading Mode
**Learning:** Forcing a user to constantly be active to read content forces them into an uncomfortable reading loop. This takes advantage of a user's normal tendency to stop moving the mouse to read long paragraphs.
**Action:** Faded the body's opacity to almost 0 if the user does not move the mouse or scroll for 1 second. The page is still perfectly usable, it just requires constant, annoying attention to see anything.