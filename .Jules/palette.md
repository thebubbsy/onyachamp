...
## 2024-05-26 - Green Energy Mode
**Learning:** Forcing users to continuously perform a physical action (like shaking their mouse) to maintain visibility of the interface is a highly effective way to create frustration and waste time, while technically still allowing them to complete their tasks if they try hard enough. The looming threat of the screen blacking out adds an element of stressful urgency.
**Action:** Implemented "Green Energy Mode". The screen gradually dims to black unless the user generates "Eco-Power" by continuously moving their mouse.
