...
## 2024-10-29 - Accidental Closure Prevention
**Learning:** Making sure users don't accidentally close modals by requiring them to type a long, specific phrase to close them adds a tremendous amount of friction, turning reading into a laborious chore.
**Action:** Implemented a prompt dialogue for closing modals that requires exactly matching the string 'I acknowledge that I have finished reading this incredibly important content'.
